---
{"tags":["Function","Equation"],"aliases":["隐函数求导公式"],"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/2.4 隐函数.md","permalink":"/A1- 数学/1. 微积分/2.4 隐函数/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Function","Equation"],"aliases":["隐函数求导公式"]}}
---
