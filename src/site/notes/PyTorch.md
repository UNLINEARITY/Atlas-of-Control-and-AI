---
{"tags":["OpenSource"],"dg-publish":true,"dg-path":"编程语言/Python/PyTorch.md","permalink":"/编程语言/Python/PyTorch/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-08-19T00:17:48.191+08:00","updated":"2025-10-21T21:37:53.817+08:00"}
---
...
PyTorch是一个开源的[[机器学习\|机器学习]]库，广泛用于[[计算机视觉\|计算机视觉]]和自然语言处理等应用。它由 Facebook 的AI研究团队开发，并得到了全球开发者社区的广泛支持。
...
#### 2.1 创建Tensor
共性：任何数据（标量、向量、矩阵、多维数组）都可以转为`torch.Tensor`。常用方式：
...
PyTorch有一套`torch.nn`模块，抽象了神经网络层和损失函数。常见套路（完全不变的框架）：
#### 5.1 定义模型
