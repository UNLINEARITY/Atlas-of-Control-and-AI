---
{"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/5.3 全微分.md","permalink":"/A1- 数学/1. 微积分/5.3 全微分/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-08-24T15:37:25.000+08:00","updated":"2025-09-05T12:57:38.000+08:00"}
---
...
$$\begin{gathered}
z=f(x,y)\quad \Rightarrow \quad    \mathrm{d}z=\dfrac{\partial z}{\partial x} \mathrm{d} x+ \dfrac{\partial z}{\partial y} \mathrm{d}y   \\
u=g(x,y,z) \quad \Rightarrow \quad \mathrm{d}u=\dfrac{\partial u}{\partial x}\mathrm{d}x+\dfrac{\partial u}{\partial y}\mathrm{d}y +\dfrac{\partial u}{\partial z}\mathrm{d}z   
\end{gathered}$$
