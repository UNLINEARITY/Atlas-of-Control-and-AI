---
{"tags":["Nonlinear","Linear"],"dg-publish":true,"dg-path":"A2- 控制理论/2. 现代控制理论/李雅普诺夫第二法.md","permalink":"/A2- 控制理论/2. 现代控制理论/李雅普诺夫第二法/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Nonlinear","Linear"]}}
---
...
>前置知识：[[对称矩阵\|正定矩阵]]  [[二次型\|二次型]]  [[能\|能]]  [[偏导数\|偏导数]]  [[状态空间\|状态空间]]  [[Lyapunov稳定性\|Lyapunov稳定性]]  
