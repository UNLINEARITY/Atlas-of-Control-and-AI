---
{"dg-publish":true,"dg-path":"A2- 控制理论/2. 现代控制理论/线性反馈系统的基本结构.md","aliases":["状态反馈"],"permalink":"/A2- 控制理论/2. 现代控制理论/线性反馈系统的基本结构/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":["状态反馈"]}}
---
