---
{"aliases":"状态空间表达式Jordan标准化,系统特征值及系统的不变量","dg-path":"A2- 控制理论/2. 现代控制理论/状态向量的线性变换.md","dg-publish":true,"permalink":"/A2- 控制理论/2. 现代控制理论/状态向量的线性变换/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":"状态空间表达式Jordan标准化,系统特征值及系统的不变量"}}
---
