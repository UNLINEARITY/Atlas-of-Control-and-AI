---
{"tags":["Linear"],"dg-publish":true,"dg-path":"A2- 控制理论/2. 现代控制理论/李雅普诺夫方法在线性系统中的应用.md","permalink":"/A2- 控制理论/2. 现代控制理论/李雅普诺夫方法在线性系统中的应用/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Linear"]}}
---
