---
{"aliases":["有理分式的分解"],"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/4.4 有理函数.md","permalink":"/A1- 数学/1. 微积分/4.4 有理函数/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":["有理分式的分解"]}}
---
