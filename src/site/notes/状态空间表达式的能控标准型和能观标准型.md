---
{"time":"2024-10-22","dg-path":"A2- 控制理论/2. 现代控制理论/状态空间表达式的能控标准型和能观标准型.md","dg-publish":true,"permalink":"/A2- 控制理论/2. 现代控制理论/状态空间表达式的能控标准型和能观标准型/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"time":"2024-10-22"}}
---
