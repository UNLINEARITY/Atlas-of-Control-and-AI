---
{"dg-publish":true,"dg-path":"A1- 数学/7. 复变函数/2.1 复积分.md","permalink":"/A1- 数学/7. 复变函数/2.1 复积分/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-05-21T15:20:28.122+08:00","updated":"2025-06-12T20:48:18.982+08:00"}
---
...
复积分可以通过两个二元实变函数的[[曲线积分\|对弧长的曲线积分]] 来计算，
曲线 $C$ 的参数方程为:$z(t)=x(t)+iy(t)$
则积分可以表示为：
$$\begin{align}
