---
{"dg-publish":true,"dg-path":"A1- 数学/7. 复变函数/2.1 复积分.md","permalink":"/A1- 数学/7. 复变函数/2.1 复积分/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-05-21T15:20:28.000+08:00","updated":"2025-09-05T11:49:07.000+08:00"}
---
...
> 这表明表明积分与积分路径圆周的中心和半径无关，实际上，此结论也是之后章节的解：[[柯西积分公式\|柯西积分公式]]、[[解析函数的高阶导数\|解析函数的高阶导数]]、[[留数\|留数]]都可推出此结论
