---
{"tags":["Linear"],"dg-path":"A1- 数学/3. 微分方程/常系数线性微分方程.md","dg-publish":true,"permalink":"/A1- 数学/3. 微分方程/常系数线性微分方程/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Linear"]}}
---
...
同时也是一阶系统矩阵的特征方程。标量方法中的 $u=e^{\lambda t}$，在线性代数中对应
...
如果特征值重合且只有一个特征向量，标量方程中的第二个解会出现 $te^{\lambda t}$；矩阵语言中这是 Jordan 块在矩阵指数中产生的多项式因子。
