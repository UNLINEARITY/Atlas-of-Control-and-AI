---
{"dg-publish":true,"dg-path":"A2- 控制理论/1. 经典控制理论/二阶系统的时域分析.md","permalink":"/A2- 控制理论/1. 经典控制理论/二阶系统的时域分析/","dgPassFrontmatter":true,"noteIcon":"","created":"2024-04-16T13:01:27.000+08:00","updated":"2025-09-18T23:09:45.192+08:00"}
---
...
> 一方面影响实部的正负来影响模态，决定发散还是收敛；另一方面决定有无虚部，决定是否振荡
>
...
![Pasted image 20250918195249.png](../img/user/Functional%20files/Photo%20Resources/Pasted%20image%2020250918195249.png)

#### 1. 不稳定    
 $\zeta<0$  两个具有正实部的极点，**发散**
 
#### 2. 无阻尼    
 $\zeta=0$  两个共轭**纯虚极点**，**等幅振荡**
$$\begin{align}
