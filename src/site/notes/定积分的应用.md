---
{"aliases":["定积分的元素法"],"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/4.9 定积分的应用.md","permalink":"/A1- 数学/1. 微积分/4.9 定积分的应用/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":["定积分的元素法"]}}
---
