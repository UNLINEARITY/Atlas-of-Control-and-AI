---
{"dg-publish":true,"dg-path":"A1- 数学/8. 变换/傅里叶变换.md","tags":["Transform"],"permalink":"/A1- 数学/8. 变换/傅里叶变换/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Transform"]}}
---
...
### 正交投影视角
傅里叶思想可以用线性代数概括：把函数或信号写成谐波之和 $c_k e^{ikx}$，再在物理空间取值与频率空间系数之间切换。在函数空间中，内积由积分给出，长度平方为
$$
\|f\|^2=\int_0^{2\pi}|f(x)|^2\,dx.
$$
因此傅里叶变换和傅里叶级数的共同核心，是把对象投影到一组正交基函数上；连续变换、离散变换和级数展开只是基函数族与取样方式不同。
