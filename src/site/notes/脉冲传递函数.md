---
{"aliases":["z 传递函数"],"dg-publish":true,"dg-path":"A2- 控制理论/3. 计算机控制系统/1.3 脉冲传递函数.md","permalink":"/A2- 控制理论/3. 计算机控制系统/1.3 脉冲传递函数/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":["z 传递函数"]}}
---
