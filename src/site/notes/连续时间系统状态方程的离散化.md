---
{"tags":["Continuous","Discrete"],"dg-publish":true,"dg-path":"A2- 控制理论/2. 现代控制理论/连续时间系统状态方程的离散化.md","permalink":"/A2- 控制理论/2. 现代控制理论/连续时间系统状态方程的离散化/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Continuous","Discrete"]}}
---
