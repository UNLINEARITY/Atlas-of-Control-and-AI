---
{"dg-publish":true,"dg-path":"计算机/测试-边.md","permalink":"/计算机/测试-边/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{}}
---
...
2. 通过这个[交互式测试器](https://extendsclass.com/regex-tester.html)体验并可视化您的正则表达式
