---
{"tags":["Function"],"aliases":["向量函数"],"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/向量值函数.md","permalink":"/A1- 数学/1. 微积分/向量值函数/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Function"],"aliases":["向量函数"]}}
---
