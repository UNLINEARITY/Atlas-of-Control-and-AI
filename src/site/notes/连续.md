---
{"tags":["Continuous"],"Level":3,"aliases":["闭区间上连续函数的性质","函数间断点"],"dg-publish":true,"dg-path":"A1- 数学/1. 微积分/2.1 连续.md","permalink":"/A1- 数学/1. 微积分/2.1 连续/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"tags":["Continuous"],"Level":3,"aliases":["闭区间上连续函数的性质","函数间断点"]}}
---
