---
{"aliases":["泰勒级数"],"dg-path":"A1- 数学/2. 级数/3.2-泰勒级数.md","dg-publish":true,"permalink":"/A1- 数学/2. 级数/3.2-泰勒级数/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"aliases":["泰勒级数"]}}
---
